...
export default function LandingPage() {
  return (
    <div className="relative overflow-hidden">
      {/* Background Decor */}
      <div className="absolute top-0 left-1/2 -z-10 h-[600px] w-[1000px] -translate-x-1/2 bg-[radial-gradient(100%_100%_at_50%_0%,rgba(34,197,94,0.08)_0%,rgba(255,255,255,0)_100%)] dark:bg-[radial-gradient(100%_100%_at_50%_0%,rgba(34,197,94,0.15)_0%,rgba(15,23,42,0)_100%)]" />

      {/* Hero Section */}
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 lg:py-32 text-center">
        <div className="inline-flex items-center gap-1.5 rounded-full bg-primary-50 dark:bg-primary-950/50 px-4 py-1.5 text-xs font-semibold text-primary-800 dark:text-primary-300 ring-1 ring-inset ring-primary-600/10 dark:ring-primary-400/20 mb-6">
          <span>🌾</span> 100% Direct Farm-to-Table Platform
        </div>
        <h1 className="mx-auto max-w-3xl text-4xl font-extrabold tracking-tight text-slate-900 dark:text-white sm:text-6xl leading-[1.1]">
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-4">
          <Link to="/register" className="btn-primary px-8 py-4 text-base shadow-lg shadow-primary-600/20 hover:shadow-primary-600/30 animate-pulse-subtle">
            Get started free
          </Link>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 border-t border-slate-100 dark:border-slate-800/80">
        <div className="text-center max-w-2xl mx-auto">
          <h2 className="text-3xl font-extrabold tracking-tight text-slate-900 dark:text-white sm:text-4xl">How it works</h2>
          <p className="mt-3 text-slate-500 dark:text-slate-400 text-sm">Three simple steps to join the local grower revolution.</p>
        </div>
          ...
          {[
            {
              ...
              desc: 'Sign up as a Grower (Farmer) or Consumer (Buyer) in under a minute.',
